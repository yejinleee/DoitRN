...
> const 캐시된*데이터 = useMemo(콜백\_함수, [deps 목록]) <br />
> 콜백\_함수 = () => 원본*데이터<br/>
> 제네릭 함수로 표현하면, <br/>
...
콜백 함수를 캐시한다. < - > useMemo는 데이터나 함수 호출의 결과값을 캐시한다.
...
> 콜백\_함수 = () => { }
>
> > 이 콜백함수는 { } 안에서 return 반환\_함수를 할 수 있는데, 이 반환\_함수는 컴포넌트를 언마운트할 때 단 한번 실행한다.

#### 리액트 넨이티브 컴포넌트의 onLayour 이벤트 속성
